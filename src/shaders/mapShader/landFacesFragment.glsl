            ...
            uniform float uHoveredLandIndex;
            uniform float uClickedLandIndex;
            ...
            void main()
            {
                ...
                // if( uHoveredLandIndex == vThisLandIndex){
                //     gl_FragColor = vec4(1.0,1.0,1.0,1.0);
                // }

                // if( uClickedLandIndex == vThisLandIndex){
                //     gl_FragColor = vec4(1.0,0.0,0.0,1.0);
                // }
                // vec4 pointsColor = vec4(1.0,0.0,0.0,1.0);
                // gl_FragColor =pointsColor;
